...
interface ApiService {
     ...
     *
     * @return The user's profile details, including ID, username, public key, creation date, and
     * optional avatar.
     */
     ...
     *
     * Sends a PUT request to the `/profile` endpoint with optional updates for the user's display
