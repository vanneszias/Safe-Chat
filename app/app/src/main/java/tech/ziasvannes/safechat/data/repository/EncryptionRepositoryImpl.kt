...
class EncryptionRepositoryImpl @Inject constructor() : EncryptionRepository {
     ...
     * @param sharedSecret The shared secret key for AES-GCM decryption.
    ...
    /**
     * Retrieves the stored public key encoded as a Base64 string.
     *
     * @return The Base64-encoded public key, or null if the key cannot be retrieved.
     */
    ...
    /**
     * Generates a new Diffie-Hellman key pair and returns the public key encoded in Base64.
     *
     * @return The Base64-encoded public key string of the newly generated key pair.
     */
